...
public partial class Paginas_Calibraciones_CalibracionNuevo : System.Web.UI.UserControl
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        var stMarca = this.sltMarca.GetStore();
        stMarca.DataSource = marca.GetData();
        stMarca.DataBind();
    ...
    public void Show()
    {
        this.VentanaCaliNueva.Show();
    }
    protected void btnGuardarNuevoCali(object sender, DirectEventArgs e)
    {
        try
        {
            decimal vpatron = 0;
            ...
            int marca = int.Parse(this.sltMarca.SelectedItem.Value);
            ...
            cali.Insert_Calibracion(art_id, marca, fecha, responsable, unid, error_instr, error_estd, vpatron, vpromedio, estado, obs);
            this.GridStore.Reload();
            this.VentanaCaliNueva.Hide();
        }
        catch (Exception)
        {
